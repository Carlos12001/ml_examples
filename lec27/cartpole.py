...
class TrainSolver:
    ...
    def __init__(self, max_episodes):
        ...
        self.render_mode="human" # render_mode="rgb_array"
        env = gym.make('CartPole-v1',render_mode=self.render_mode)
    ...
    def train(self):
        ...
        while episode < self.max_episodes:
            ...
            while True:
                ...
                self.solver.add_to_memory(state, action, reward, state_next, terminated or truncated)
                state = state_next
